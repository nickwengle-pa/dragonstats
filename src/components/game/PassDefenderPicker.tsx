...
export default function PassDefenderPicker({ team, players, selected, onSelect, onClear, accentColor, onAddJersey }: {
  accentColor: string;
  ...
  return <div className="defense-selection space-y-2" style={{ "--defense-accent": accentColor } as CSSProperties}>
    <PlayerPicker label="Pass defender / breakup (optional)" team={team} players={players}
      role="defender" selected={selected} onSelect={onSelect} accentColor={accentColor} onAddJersey={onAddJersey} />
