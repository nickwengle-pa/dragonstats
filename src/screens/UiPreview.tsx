...
export default function UiPreview() {
  ...
  function undo() {
    ...
    setState(last.before); setDraft(last.draft); setEntries(p => p.slice(0, -1)); setLogPage(0); setPaused(false); setClockEdit(false); setNotice("Last play restored for editing.");
  }
  ...
  return <main className="ui-preview">
    ...
    <div className="ui-columns"><section className={`ui-entry ${detail ? "ui-detailed" : ""}`}>
